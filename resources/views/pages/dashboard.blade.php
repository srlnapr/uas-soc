    ...
    <div class="container">
      <div class="flex flex-col lg:flex-row">
        <div class="w-full self-center px-4">
          ...
          *Disclaimer* Hasil diagnosis ini hanya berdasarkan Kualitatif.
           Disarankan untuk pergi ke rumah sakit untuk mendapatkan hasil Kuantitatif
          </p>
          @else
          <p class="mb-3 text-slate-500">
            Anda bisa melihat semua detail disini.
          </p>
          @endif
        </div>
