  ...
  <section class="pt-28 pb-24 lg:pt-36">
    <div class="container">
      ...
      <div class="w-full self-center px-4">
        ...
        style="width: 100%; border-radius: 0.375rem; border: 2px solid #000; background-color: #000; color: #fff; padding: 0.75rem 1.5rem; transition: background-color 0.3s, color 0.3s;"
